...
import  editMaterial  from './instructor/materialCourse/material.controller.js';
import  deleteMaterial  from './instructor/materialCourse/material.controller.js';
...
const bootstrap = (app, express) => {
  ...
  app.use('/courseMaterial',uploadMaterial);
  app.use('/courseMaterial',editMaterial);
  app.use('/courseMaterial',deleteMaterial);
  app.use('/courseMaterial', viewMaterialCourse);
  app.use('/exam', examController);
  app.use('/message', MessageController);
  app.use('/assignment', assignmentController);
